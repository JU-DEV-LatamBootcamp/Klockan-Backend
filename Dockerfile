...
COPY KlockanAPI/tests/KlockanAPI.Integration.Tests/*.csproj tests/KlockanAPI.Integration.Tests/
...
COPY KlockanAPI/tests/KlockanAPI.Integration.Tests/. ./tests/KlockanAPI.Integration.Tests/
